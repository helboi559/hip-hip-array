...
for(let i = 0 ; i < fibonacciNumbers.length; i++) {
  fibonacciNumbers.unshift(2)
  fibonacciNumbers.push(2,4)
  console.log(fibonacciNumbers[i])
}

// Challenge 7
// Make a NEW array with 5 values of your choice, using the same syntax as the array creation from the previous 6 challenges; that is, every value should be placed within the square brackets.  Now console.log out each value individually.
const newArr = [2, 3, false, 'hello', 300, 'world'] 
...
const copyArr = students.slice(3,11)
let combined =students.concat(copyArr)
...
const copy = students.slice(3,11)
const copyArr = students.slice(3,11)
console.log(copyArr)
...
//OR
const newWord = dinosaurs.join('*')

console.log(newWord)

// Challenge 14
// Use .reverse to reverse the dinosaur array and then log out the original array. .reverse DOES change the original array.
let dinoRev = dinosaurs.reverse()
console.log(dinoRev)
